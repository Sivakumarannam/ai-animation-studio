          ...
          {PHASES.map(phase => {
            ...
            return (
              <div key={phase.key} className="card p-5 space-y-3">
                ...
                <div className="flex items-center gap-6 text-sm border-t border-gray-800 pt-3 flex-wrap">
                  <div>
                  ...
                  {info?.next_run_at && (
                    <div>
                      ...
                      <p className="text-gray-300">{new Date(info.next_run_at).toLocaleString()}</p>
                    </div>
                  )}
                </div>
              </div>
